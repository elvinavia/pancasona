...
export default function Home() {
  return (
    <section className="text-center p-5">
      <Image src="/logo.jpg" alt="Logo Karang Taruna" width={150} height={150} className="mx-auto"/>

      <h1 className="text-3xl font-bold mt-4">Karang Taruna PANCASONA</h1>
      <br/> 
      
      <p className="mt-2 text-white-700"> Karang Taruna RW 05 <strong>PANCASONA</strong> adalah organisasi kepemudaan
